    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-timeline">
                <div class="timeline">
                    <div class="timeline-content">
                        <div class="circle"><span class="homebox">
                          <img src="https://picsum.photos/id/200/200" class="img"/>
                         </span></div>
                        <div class="content">
                            <span class="year">Our Fest</span>
                ...
                <div class="timeline">
                    <div class="timeline-content">
                        <div class="circle"><span class="homebox"><img src="https://picsum.photos/300/300" class="img" /></span></div>
                        <div class="content">
                            <span class="year">Our Events</span>
                            {/* <h3 class="title h4">Heading</h3> */}
                            <p class="description">
                ...
                <div class="timeline">
                    <div class="timeline-content">
                        <div class="circle"><span class="homebox"><img src="https://picsum.photos/210/210" class="img"/></span></div>
                        <div class="content">
                            <span class="year">Heading</span>
                            {/* <h3 class="title h4">Heading</h3> */}
                            <p class="description">
                ...
                <div class="timeline">
                    <div class="timeline-content">
                        <div class="circle"><span class="homebox"><img src="https://picsum.photos/220/220" class="img"/></span></div>
                        <div class="content">
                            <span class="year">Heading</span>
                            {/* <h3 class="title h4">Heading</h3> */}
                            <p class="description">
                ...
                <div class="timeline">
                    <div class="timeline-content">
                        <div class="circle"><span class="homebox"><img src="https://picsum.photos/164" class="img"/></span></div>
                        {/* <div class="circle"><img src="https://picsum.photos/164" class="img"/></div> */}
                        <div class="content">
                            <span class="year">Heading</span>
                            {/* <h3 class="title h4">Heading</h3> */}
                            <p class="description">
